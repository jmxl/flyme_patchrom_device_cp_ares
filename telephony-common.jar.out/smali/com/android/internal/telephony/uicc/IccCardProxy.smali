...
.method private updateExternalState()V
    ...
    const-string/jumbo v0, "ro.boot.factoryimg"
...
.method public iccIO(IILjava/lang/String;IIILjava/lang/String;Ljava/lang/String;Landroid/os/Message;ZLjava/lang/String;)Ljava/lang/String;
    .locals 13
    .param p1, "command"    # I
    .param p2, "fileid"    # I
    ...
    .param p10, "useUiccAid"    # Z
    .param p11, "customAid"    # Ljava/lang/String;
    ...
    .line 961
    .local v9, "theAid":Ljava/lang/String;
    iget-object v12, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mLock:Ljava/lang/Object;
    ...
    .line 964
    const-string/jumbo v0, "VSIM - UICC PRESENT!"
    ...
    .line 971
    .end local v9    # "theAid":Ljava/lang/String;
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mUiccApplication:Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    invoke-virtual/range {v0 .. v10}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->iccIOForApp(IILjava/lang/String;IIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 968
    .restart local v9    # "theAid":Ljava/lang/String;
    :cond_2
    if-eqz p11, :cond_0
    ...
    .line 976
    const-string/jumbo v0, "VSIM - UICC MISSING But MCI here!"
    ...
    .line 984
    const-string/jumbo v0, "VSIM - UICC MISSING And MCI Missing!"
    ...
    const-string/jumbo v0, "ICC card is absent."

    invoke-direct {v11, v0}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;)V

    .line 987
    .local v11, "e":Ljava/lang/Exception;
    invoke-static/range {p9 .. p9}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;)Landroid/os/AsyncResult;
...
.method public krIccio(IILjava/lang/String;IIILjava/lang/String;Ljava/lang/String;Landroid/os/Message;ZLjava/lang/String;)Ljava/lang/String;
    .locals 13
    .param p1, "command"    # I
    .param p2, "fileid"    # I
    .param p3, "path"    # Ljava/lang/String;
...
.method public refreshSimRecords()V
    .locals 4
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/uicc/SIMRecords;->fetchSimRecords()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 1054
    .end local v1    # "simRecords":Lcom/android/internal/telephony/uicc/SIMRecords;
    :goto_0
    return-void
    ...
    const-string/jumbo v3, "VSIM - Failed to refresh! "
    ...
    .end local v0    # "e":Ljava/lang/Exception;
    :cond_0
    const-string/jumbo v2, "VSIM - UICC empty"
...
.method public uiccApplicationIsPresent()Z
    .locals 1
