...
.field private static final CHANGE_4G_CARD:I = 0x0
...
.field private static final EVENT_ICC_OPERATOR_REQUIREMENT:I = 0xb
...
.method private constructor <init>(Landroid/content/Context;[Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    invoke-virtual {p0, v2, v4, v5}, Lcom/android/internal/telephony/uicc/UiccController;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method private getIccId(I)Ljava/lang/String;
    ...
    .line 461
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/uicc/UiccController;->getUiccCard(I)Lcom/android/internal/telephony/uicc/UiccCard;

    move-result-object v0

    .line 462
    .local v0, "ic":Lcom/android/internal/telephony/uicc/UiccCard;
    if-eqz v0, :cond_0
    ...
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/uicc/UiccController;->isAppReady(I)Z
    ...
    .line 468
    .end local v1    # "mCardState":Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;
    :cond_0
    return-object v3
.end method
...
.method private isIccidChanged(I)Z
    .locals 7
    .param p1, "slotId"    # I
    ...
    const-string/jumbo v5, "isIccidChanged slotId = "
    ...
    const-string/jumbo v5, "iccid_UiccController_"
    ...
    .line 492
    .local v2, "iccidOld":Ljava/lang/String;
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/uicc/UiccController;->getIccId(I)Ljava/lang/String;

    move-result-object v1

    .line 493
    .local v1, "iccidNew":Ljava/lang/String;
    if-nez v2, :cond_1
    ...
    .line 502
    .end local v1    # "iccidNew":Ljava/lang/String;
    .end local v2    # "iccidOld":Ljava/lang/String;
...
.method private processCarrierRequirement()V
    .locals 7
    ...
    .line 430
    sget-object v4, Lcom/zeusis/hydra/utils/HydraCarrierCust$CarrierType;->CT:Lcom/zeusis/hydra/utils/HydraCarrierCust$CarrierType;
    ...
    .line 431
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/uicc/UiccController;->isLteCard(I)Z
    ...
    const-string/jumbo v5, "remind user change 4g card"

    invoke-static {v4, v5}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 433
    const-string/jumbo v4, "change4GCard"

    invoke-direct {p0, v4, v6}, Lcom/android/internal/telephony/uicc/UiccController;->remindChangeCard(Ljava/lang/String;I)V
    ...
    .line 436
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/uicc/UiccController;->isIccidChanged(I)Z

    move-result v1

    .line 437
    .local v1, "iccidChg1":Z
    const/4 v4, 0x1

    invoke-direct {p0, v4}, Lcom/android/internal/telephony/uicc/UiccController;->isIccidChanged(I)Z

    move-result v2

    .line 438
    .local v2, "iccidChg2":Z
    if-nez v1, :cond_2
    ...
    .line 440
    const-string/jumbo v4, "com.yulong.android.settings.SIMS_STATUS_CHANGED"
    ...
    const-string/jumbo v4, "sims_status_changed"
    ...
    const-string/jumbo v5, "remind user card been changed in CU mode !"
...
.method private remindChangeCard(Ljava/lang/String;I)V
    .locals 4
    .param p1, "state"    # Ljava/lang/String;
    .param p2, "slotIdFlag"    # I
    ...
    const-string/jumbo v3, "remindChangeCard,state: "
    ...
    const-string/jumbo v3, ", changeType = "
    ...
    const-string/jumbo v2, "yulong.provider.Telephony.DUAL_OPERATOR_STATE_CHANGE"
    ...
    .line 512
    const-string/jumbo v2, "slotIdFlag"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 263
    :pswitch_5
    const-string/jumbo v2, "Received EVENT_ICC_OPERATOR_REQUIREMENT"

    invoke-direct {p0, v2}, Lcom/android/internal/telephony/uicc/UiccController;->log(Ljava/lang/String;)V

    .line 264
    invoke-direct {p0}, Lcom/android/internal/telephony/uicc/UiccController;->processCarrierRequirement()V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method public isAppReady(I)Z
    ...
    invoke-virtual {v4, p1, v6}, Lcom/android/internal/telephony/uicc/UiccController;->getUiccCardApplication(II)Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    .line 475
    .local v2, "appState3GPP":Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;
    :goto_0
    invoke-static {}, Lcom/android/internal/telephony/uicc/UiccController;->getInstance()Lcom/android/internal/telephony/uicc/UiccController;
    ...
    .line 475
    invoke-virtual {v4, p1, v5}, Lcom/android/internal/telephony/uicc/UiccController;->getUiccCardApplication(II)Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    .line 479
    .local v3, "appState3GPP2":Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;
    :goto_1
    ...
    .line 480
    :cond_0
    const-string/jumbo v4, "isAppReady == true"
    ...
    .line 473
    .end local v1    # "app3GPP2":Lcom/android/internal/telephony/uicc/UiccCardApplication;
    .end local v2    # "appState3GPP":Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;
    .end local v3    # "appState3GPP2":Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;
    :cond_1
    ...
    .restart local v2    # "appState3GPP":Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;
    goto :goto_0

    .line 477
    .restart local v1    # "app3GPP2":Lcom/android/internal/telephony/uicc/UiccCardApplication;
    :cond_2
    ...
    .restart local v3    # "appState3GPP2":Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;
    goto :goto_1
