...
.method private promptForRestart(Z)V
    ...
    new-instance v10, Lcom/zeusis/widget/dialog/AlertDialog$Builder;

    iget-object v12, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mContext:Landroid/content/Context;

    invoke-direct {v10, v12}, Lcom/zeusis/widget/dialog/AlertDialog$Builder;-><init>(Landroid/content/Context;)V

    invoke-virtual {v10, v9}, Lcom/zeusis/widget/dialog/AlertDialog$Builder;->setTitle(Ljava/lang/CharSequence;)Lcom/zeusis/widget/dialog/AlertDialog$Builder;

    move-result-object v10

    invoke-virtual {v10, v6}, Lcom/zeusis/widget/dialog/AlertDialog$Builder;->setMessage(Ljava/lang/CharSequence;)Lcom/zeusis/widget/dialog/AlertDialog$Builder;

    move-result-object v10

    invoke-virtual {v10, v0, v5}, Lcom/zeusis/widget/dialog/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Lcom/zeusis/widget/dialog/AlertDialog$Builder;

    move-result-object v10

    invoke-virtual {v10}, Lcom/zeusis/widget/dialog/AlertDialog$Builder;->create()Lcom/zeusis/widget/dialog/AlertDialog;

    move-result-object v1

    .line 378
    .local v1, "dialog":Lcom/zeusis/widget/dialog/AlertDialog;
    ...
    .end local v1    # "dialog":Lcom/zeusis/widget/dialog/AlertDialog;
...
.method private promptInstallCarrierApp(Ljava/lang/String;)V
    ...
    invoke-direct {v6, v7}, Lcom/zeusis/widget/dialog/AlertDialog$Builder;-><init>(Landroid/content/Context;)V

    invoke-virtual {v6, v3}, Lcom/zeusis/widget/dialog/AlertDialog$Builder;->setMessage(Ljava/lang/CharSequence;)Lcom/zeusis/widget/dialog/AlertDialog$Builder;

    move-result-object v6

    invoke-virtual {v6, v4, v2}, Lcom/zeusis/widget/dialog/AlertDialog$Builder;->setNegativeButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Lcom/zeusis/widget/dialog/AlertDialog$Builder;

    move-result-object v6

    invoke-virtual {v6, v0, v2}, Lcom/zeusis/widget/dialog/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Lcom/zeusis/widget/dialog/AlertDialog$Builder;
