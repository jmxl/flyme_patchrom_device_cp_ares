...
.field public static final WAP_PUSH_SMS:I = 0x1

.field public static mExtInterfaceParse:Lyulong/config/SmsExternInterfaceParse;
...
.method protected constructor <init>(Ljava/lang/String;Landroid/content/Context;Lcom/android/internal/telephony/SmsStorageMonitor;Lcom/android/internal/telephony/Phone;Lcom/android/internal/telephony/CellBroadcastHandler;)V
    ...
    .line 250
    invoke-direct {p0}, Lcom/android/internal/telephony/InboundSmsHandler;->acquireWakeLockWithoutTimeout()V
    ...
    const-string/jumbo v4, "SmsExternInterfaceParse: "
    ...
    .line 264
    sget-object v2, Lcom/android/internal/telephony/InboundSmsHandler;->mExtInterfaceParse:Lyulong/config/SmsExternInterfaceParse;

    if-nez v2, :cond_0

    .line 265
    new-instance v2, Lyulong/config/SmsExternInterfaceParse;

    iget-object v3, p0, Lcom/android/internal/telephony/InboundSmsHandler;->mContext:Landroid/content/Context;

    invoke-direct {v2, v3}, Lyulong/config/SmsExternInterfaceParse;-><init>(Landroid/content/Context;)V

    sput-object v2, Lcom/android/internal/telephony/InboundSmsHandler;->mExtInterfaceParse:Lyulong/config/SmsExternInterfaceParse;

    .line 266
    sget-object v2, Lcom/android/internal/telephony/InboundSmsHandler;->mExtInterfaceParse:Lyulong/config/SmsExternInterfaceParse;

    invoke-virtual {v2}, Lyulong/config/SmsExternInterfaceParse;->start()V
...
.method private acquireWakeLockWithoutTimeout()V
    .locals 2
...
.method private processMessagePart(Lcom/android/internal/telephony/InboundSmsTracker;)Z
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/android/internal/telephony/InboundSmsTracker;->getIndexOnIcc()I

    move-result v4

    move-object/from16 v0, p0

    invoke-virtual {v0, v8, v2, v3, v4}, Lcom/android/internal/telephony/InboundSmsHandler;->handleSmsFilter([[BLjava/lang/String;Ljava/lang/String;I)I
    ...
    const-string/jumbo v3, "long sms filter,"
...
.method protected dispatchNormalMessage(Lcom/android/internal/telephony/SmsMessageBase;)I
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/telephony/InboundSmsTracker;->setIndexOnIcc(I)V
...
.method public handleSmsFilter([[BLjava/lang/String;Ljava/lang/String;I)I
    ...
    new-array v15, v2, [Landroid/telephony/SmsMessage;

    .line 1735
    .local v15, "msgs":[Landroid/telephony/SmsMessage;
    const/4 v14, 0x0

    .line 1737
    .local v14, "indexNotNull":I
    const/4 v2, -0x1
    ...
    invoke-static {v0, v2, v1}, Landroid/telephony/SmsMessage;->createFromEfRecordByFormat(I[BLjava/lang/String;)Landroid/telephony/SmsMessage;
    ...
    invoke-virtual {v4}, Landroid/telephony/SmsMessage;->getStatusOnIcc()I
    ...
    const-string/jumbo v3, "handleSmsFilter bRet:"
