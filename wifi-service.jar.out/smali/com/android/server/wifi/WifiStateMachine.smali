...
.field private static final BRD_PICKAVALIABLEWLANNETWORK:Ljava/lang/String; = "com.zeusis.android.wifi.action.PICKAVALIABLEWLANNETWORK"

.field private static final BRD_WIFICONNECTED:Ljava/lang/String; = "com.zeusis.android.wifi.action.WIFICONNECTED"
...
.field private static final INTENT_EXTRA_CHOOSE_TYPE:Ljava/lang/String; = "ChooseType"

.field private static final INTENT_EXTRA_CHOOSE_TYPE_DISCONNECT:I = 0x1

.field private static final INTENT_EXTRA_CHOOSE_TYPE_WEAKSIGNAL:I = 0x0
...
.field private mZeusisSoftApLimitDate:Lcom/android/server/wifi/ZeusisSoftApLimitDate;

.field private mZeusisWifiDataCutOff:Lcom/android/server/wifi/ZeusisWifiDataCutOff;
...
.method static synthetic -get11(Lcom/android/server/wifi/WifiStateMachine;)Landroid/util/BugManager;
    .locals 1

    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine;->mBugManager:Landroid/util/BugManager;
...
.method static synthetic -get17(Lcom/android/server/wifi/WifiStateMachine;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -get37(Lcom/android/server/wifi/WifiStateMachine;)Landroid/net/LinkProperties;
    .locals 1
...
.method static synthetic -get98(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/ZeusisWifiDataCutOff;
    .locals 1

    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine;->mZeusisWifiDataCutOff:Lcom/android/server/wifi/ZeusisWifiDataCutOff;
...
.method static synthetic -set25(Lcom/android/server/wifi/WifiStateMachine;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/wifi/WifiStateMachine;->mPoorRssiTip:Z
...
.method static synthetic -wrap15(Lcom/android/server/wifi/WifiStateMachine;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/WifiStateMachine;->WifiStateTips()V

    return-void
.end method

.method static synthetic -wrap16(Lcom/android/server/wifi/WifiStateMachine;ILandroid/net/wifi/WifiConfiguration;)V
    .locals 0
...
.method static synthetic -wrap19(Lcom/android/server/wifi/WifiStateMachine;Landroid/os/Message;)V
    .locals 0
...
.method static synthetic -wrap33(Lcom/android/server/wifi/WifiStateMachine;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wifi/WifiStateMachine;->processDriverHuangEvent()V
...
.method static synthetic -wrap41(Lcom/android/server/wifi/WifiStateMachine;Z)V
    .locals 0
...
.method static synthetic -wrap44(Lcom/android/server/wifi/WifiStateMachine;IZ)V
    .locals 0
    .param p1, "reason"    # I
    .param p2, "enabled"    # Z
...
.method static synthetic -wrap45(Lcom/android/server/wifi/WifiStateMachine;IZ)V
    .locals 0
    .param p1, "reason"    # I
    .param p2, "enabled"    # Z
...
.method static synthetic -wrap46(Lcom/android/server/wifi/WifiStateMachine;II)V
    .locals 0
...
.method static synthetic -wrap49(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    .locals 0
...
.method static synthetic -wrap50(Lcom/android/server/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfiguration;)V
    .locals 0
...
.method static synthetic -wrap51(Lcom/android/server/wifi/WifiStateMachine;)V
    .locals 0
...
.method static synthetic -wrap52(Lcom/android/server/wifi/WifiStateMachine;Landroid/net/LinkProperties;)V
    .locals 0
...
.method static synthetic -wrap53(Lcom/android/server/wifi/WifiStateMachine;Lcom/android/server/wifi/WnmData;)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/FrameworkFacade;Landroid/os/Looper;Landroid/os/UserManager;Lcom/android/server/wifi/WifiInjector;Lcom/android/server/wifi/BackupManagerProxy;Lcom/android/server/wifi/WifiCountryCode;)V
    ...
    iput-boolean v2, v0, Lcom/android/server/wifi/WifiStateMachine;->mPoorRssiTip:Z
    ...
    iput-object v2, v0, Lcom/android/server/wifi/WifiStateMachine;->mBugManager:Landroid/util/BugManager;
    ...
    iput-boolean v2, v0, Lcom/android/server/wifi/WifiStateMachine;->gDumpLogFlag:Z
    ...
    const-string/jumbo v3, "WIFI-FWK"

    const-string/jumbo v4, "WifiStateMachine"

    invoke-direct {v2, v3, v4}, Landroid/util/BugManager;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1139
    new-instance v2, Lcom/android/server/wifi/ZeusisWifiDataCutOff;

    move-object/from16 v0, p1

    move-object/from16 v1, p0

    invoke-direct {v2, v0, v1}, Lcom/android/server/wifi/ZeusisWifiDataCutOff;-><init>(Landroid/content/Context;Lcom/android/server/wifi/WifiStateMachine;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/wifi/WifiStateMachine;->mZeusisWifiDataCutOff:Lcom/android/server/wifi/ZeusisWifiDataCutOff;

    .line 1141
    new-instance v2, Lcom/android/server/wifi/ZeusisSoftApLimitDate;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/wifi/WifiStateMachine;->mNwService:Landroid/os/INetworkManagementService;
    ...
    invoke-direct {v2, v0, v1, v3, v4}, Lcom/android/server/wifi/ZeusisSoftApLimitDate;-><init>(Landroid/content/Context;Lcom/android/server/wifi/WifiStateMachine;Landroid/os/INetworkManagementService;Ljava/lang/String;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/wifi/WifiStateMachine;->mZeusisSoftApLimitDate:Lcom/android/server/wifi/ZeusisSoftApLimitDate;
...
.method private WifiStateTips()V
    ...
    const-string/jumbo v2, "send disconnect broadcast PICKAVALIABLEWLANNETWORK ChooseType 1"
    ...
    const-string/jumbo v1, "com.zeusis.android.wifi.action.PICKAVALIABLEWLANNETWORK"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 8829
    .local v0, "pickupIntent":Landroid/content/Intent;
    const-string/jumbo v1, "ChooseType"
...
.method private checkOrDeferScanAllowed(Landroid/os/Message;)Z
    ...
    const-string/jumbo v5, "lastConnectAttemptTimestamp:"
...
.method private fetchRssiLinkSpeedAndFrequencyNative()V
    ...
    const-string/jumbo v13, "LINKSPEED"
    ...
    const-string/jumbo v11, "fetchRssiLinkSpeedAndFrequencyNative rssi="
    ...
    .line 3393
    const-string/jumbo v11, " linkspeed="
    ...
    invoke-virtual {p0, v10}, Lcom/android/server/wifi/WifiStateMachine;->logd(Ljava/lang/String;)V

    .line 3396
    :cond_5
    const-string/jumbo v10, "WifiStateMachine"

    const-string/jumbo v11, "newRssi IS NULL?"
    ...
    .line 3407
    iget-boolean v10, p0, Lcom/android/server/wifi/WifiStateMachine;->mPoorRssiTip:Z
    ...
    iput-boolean v10, p0, Lcom/android/server/wifi/WifiStateMachine;->mPoorRssiTip:Z
    ...
    const-string/jumbo v12, ",mPoorRssiTip: "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-boolean v12, p0, Lcom/android/server/wifi/WifiStateMachine;->mPoorRssiTip:Z
    ...
    .line 3411
    const-string/jumbo v10, "persist.sys.wlanautoreass"
    ...
    const-string/jumbo v11, "when the signal is poor,and set auto reassociate to others,come to here"
    ...
    const-string/jumbo v11, "*****delete mWifiNative.reassociate()*****"
    ...
    invoke-virtual {v10, v11}, Lcom/android/server/wifi/WifiMetrics;->incrementRssiPollRssiCount(I)V
    ...
    iget v10, p0, Lcom/android/server/wifi/WifiStateMachine;->mLastSignalLevel:I
    ...
    invoke-direct {p0, v10}, Lcom/android/server/wifi/WifiStateMachine;->updateCapabilities(Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-direct {p0, v10}, Lcom/android/server/wifi/WifiStateMachine;->sendRssiChangeBroadcast(I)V
    ...
    invoke-virtual {v10, v11}, Landroid/net/wifi/WifiInfo;->setLinkSpeed(I)V
    ...
    .line 3455
    iget-object v10, p0, Lcom/android/server/wifi/WifiStateMachine;->mWifiConnectionStatistics:Landroid/net/wifi/WifiConnectionStatistics;

    iget v11, v10, Landroid/net/wifi/WifiConnectionStatistics;->num5GhzConnected:I

    add-int/lit8 v11, v11, 0x1

    iput v11, v10, Landroid/net/wifi/WifiConnectionStatistics;->num5GhzConnected:I
    ...
    iget v11, v10, Landroid/net/wifi/WifiConnectionStatistics;->num24GhzConnected:I

    add-int/lit8 v11, v11, 0x1

    iput v11, v10, Landroid/net/wifi/WifiConnectionStatistics;->num24GhzConnected:I
    ...
    invoke-virtual {v10, v11}, Landroid/net/wifi/WifiInfo;->setFrequency(I)V
    ...
    invoke-virtual {v10, v11}, Lcom/android/server/wifi/WifiConfigManager;->updateConfiguration(Landroid/net/wifi/WifiInfo;)V
    ...
    const-string/jumbo v11, "signal is poor,sendBroadcast~~~~~~~~~~"
    ...
    const-string/jumbo v10, "com.zeusis.android.wifi.action.PICKAVALIABLEWLANNETWORK"

    invoke-direct {v7, v10}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 3418
    .local v7, "pickupIntent":Landroid/content/Intent;
    const-string/jumbo v10, "ChooseType"
    ...
    .line 3446
    .end local v7    # "pickupIntent":Landroid/content/Intent;
    :cond_f
    iget-object v10, p0, Lcom/android/server/wifi/WifiStateMachine;->mWifiInfo:Landroid/net/wifi/WifiInfo;
...
.method private handleIPv4Success(Landroid/net/DhcpResults;)V
    ...
    const-string/jumbo v9, "handleIPv4Success <"
    ...
    const-string/jumbo v9, "link address "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p1, Landroid/net/DhcpResults;->ipAddress:Landroid/net/LinkAddress;
    ...
    .line 3931
    :cond_0
    iget-object v9, p0, Lcom/android/server/wifi/WifiStateMachine;->mDhcpResultsLock:Ljava/lang/Object;
    ...
    .line 3933
    iget-object v8, p1, Landroid/net/DhcpResults;->ipAddress:Landroid/net/LinkAddress;
    ...
    iget-object v8, p0, Lcom/android/server/wifi/WifiStateMachine;->mDhcpResults:Landroid/net/DhcpResults;
    ...
    iget-object v8, v8, Landroid/net/DhcpResults;->gateway:Ljava/net/InetAddress;

    if-eqz v8, :cond_1

    .line 3940
    const-string/jumbo v8, "dhcp.wlan0.gateway"

    iget-object v10, p0, Lcom/android/server/wifi/WifiStateMachine;->mDhcpResults:Landroid/net/DhcpResults;

    iget-object v10, v10, Landroid/net/DhcpResults;->gateway:Ljava/net/InetAddress;
    ...
    const-string/jumbo v10, "Gateway is:"
    ...
    const-string/jumbo v10, "dhcp.wlan0.dns"
    ...
    const-string/jumbo v9, "handleIPv4Success, roaming and address changed"
    ...
    .line 3964
    .end local v5    # "newAddress":I
    .end local v6    # "previousAddress":I
    :cond_3
    iget-object v8, p0, Lcom/android/server/wifi/WifiStateMachine;->mWifiInfo:Landroid/net/wifi/WifiInfo;

    invoke-virtual {v8, v0}, Landroid/net/wifi/WifiInfo;->setInetAddress(Ljava/net/InetAddress;)V

    .line 3965
    iget-object v8, p0, Lcom/android/server/wifi/WifiStateMachine;->mWifiInfo:Landroid/net/wifi/WifiInfo;

    invoke-virtual {v8}, Landroid/net/wifi/WifiInfo;->getMeteredHint()Z
    ...
    invoke-virtual {v8, v9}, Landroid/net/wifi/WifiInfo;->setMeteredHint(Z)V
    ...
    invoke-direct {p0, v8}, Lcom/android/server/wifi/WifiStateMachine;->updateCapabilities(Landroid/net/wifi/WifiConfiguration;)V
...
.method private isShouldDynamicConfAP()Z
    .locals 1
...
.method private processDriverHuangEvent()V
    .locals 4
    ...
    .line 4327
    const-string/jumbo v0, "Receive DRIVER_HUNG_EVENT"
    ...
    .line 4330
    const-string/jumbo v0, "Recovery is ongoing, ignore this DRIVER_HUNG_EVENT"
    ...
    .line 4335
    const-string/jumbo v0, "Recovery for STA"
    ...
    .line 4339
    invoke-virtual {p0, v2, v3}, Lcom/android/server/wifi/WifiStateMachine;->setSilentHungEnabled(ZZ)V

    .line 4342
    :cond_1
    iput-boolean v2, p0, Lcom/android/server/wifi/WifiStateMachine;->mRecoveryIsOngoing:Z
    ...
    .line 4345
    invoke-virtual {p0, v2}, Lcom/android/server/wifi/WifiStateMachine;->setSupplicantRunning(Z)V
...
.method private sendNetworkStateChangeBroadcast(Ljava/lang/String;)V
    ...
    .line 3622
    const-string/jumbo v2, " ===> skip sendNetworkStateChangeBroadcast by silent HUNG"
...
.method private setWifiApState(II)V
    ...
    iput-boolean v3, p0, Lcom/android/server/wifi/WifiStateMachine;->mRecoveryIsOngoing:Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private setWifiState(I)V
    ...
    .line 3239
    const-string/jumbo v3, " ===> skip setWifiState by silent HUNG"
...
.method public getDefCountryCodeFromProperty()Ljava/lang/String;
    .locals 3

    .prologue
    .line 4354
    const-string/jumbo v1, "persist.zeusis.sys.country"
    ...
    const-string/jumbo v2, "CountryCode is "
...
.method getWifiLinkLayerStats(Z)Landroid/net/wifi/WifiLinkLayerStats;
    ...
    iget-boolean v6, p0, Lcom/android/server/wifi/WifiStateMachine;->mRecoveryIsOngoing:Z
    ...
    const-string/jumbo v7, "getWifiLinkLayerStats: return from WifiHal"
    ...
    const-string/jumbo v7, "getWifiLinkLayerStats: WIFI is not enbled"
...
.method public setSilentHungEnabled(ZZ)V
    ...
    .prologue
    .line 4294
    const-string/jumbo v0, "wifi.disable.silenthung"
    ...
    .line 4295
    const-string/jumbo v0, "silent HUNG disabled"
    ...
    .line 4301
    const-string/jumbo v0, "wlan.silentHung.enabled"
    ...
    const-string/jumbo v1, "mSilentHungEnabled enable: "
    ...
    invoke-virtual {p0, v2, v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->sendMessageDelayed(IJ)V
    ...
    const-string/jumbo v1, "mSilentHungEnabled getCurrentState: "
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wifi/WifiStateMachine;->sendScanResultsAvailableBroadcast(Z)V
...
.method public syncGetAclType()I
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/android/server/wifi/WifiApConfigStore;->getAclType()I
...
.method public syncGetHiddenSsid()Z
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/android/server/wifi/WifiApConfigStore;->getHiddenSsid()Z
...
.method public syncGetLinkLayerStats(Lcom/android/internal/util/AsyncChannel;)Landroid/net/wifi/WifiLinkLayerStats;
    ...
    iget-boolean v2, p0, Lcom/android/server/wifi/WifiStateMachine;->mRecoveryIsOngoing:Z
    ...
    const-string/jumbo v3, "syncGetLinkLayerStats return null, due to not ready"
...
.method public syncGetMaxNumOfClients()I
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/android/server/wifi/WifiApConfigStore;->getMaxNumOfClients()I
...
.method public syncSetAclList(ILjava/lang/String;)V
    .locals 4
    .param p1, "type"    # I
    ...
    const-string/jumbo v3, "add_to_allow_list="
    ...
    invoke-interface {v1, v2}, Landroid/os/INetworkManagementService;->execQcommAPI(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v3, " setAclList "
    ...
    const-string/jumbo v3, "remove_from_allow_list="
    ...
    const-string/jumbo v3, "add_to_deny_list="
    ...
    const-string/jumbo v3, "remove_from_deny_list="
...
.method public syncSetAclType(I)V
    .locals 4
    .param p1, "aclType"    # I
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wifi/WifiApConfigStore;->setAclType(I)V

    .line 8871
    invoke-direct {p0}, Lcom/android/server/wifi/WifiStateMachine;->isShouldDynamicConfAP()Z
    ...
    const-string/jumbo v3, "macaddr_acl="
    ...
    const-string/jumbo v3, " setMacaddr_acl fail : "
...
.method public syncSetHiddenSsid(Z)V
    .locals 4
    .param p1, "hidden"    # Z
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wifi/WifiApConfigStore;->setHiddenSsid(Z)V
    ...
    const-string/jumbo v3, "ignore_broadcast_ssid="
    ...
    invoke-interface {v2, v1}, Landroid/os/INetworkManagementService;->execQcommAPI(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v3, " setHiddenSsid fail : "
...
.method public syncSetMaxNumOfClients(I)V
    .locals 4
    .param p1, "limit"    # I
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wifi/WifiApConfigStore;->setMaxNumOfClients(I)V
    ...
    const-string/jumbo v3, " setMaxnumOfClient fail : "
...
.method public syncSetZeusisAclType(I)V
    .locals 4
    .param p1, "aclType"    # I
    ...
    const-string/jumbo v3, "dmmacaddr_acl="
    ...
    const-string/jumbo v3, " setDmmacaddr_acl fail : "
...
.method public syncgetBlackList()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0}, Lcom/android/server/wifi/WifiApConfigStore;->loadBlackList()Ljava/util/ArrayList;
...
.method public syncgetWhiteList()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0}, Lcom/android/server/wifi/WifiApConfigStore;->loadWhiteList()Ljava/util/ArrayList;
...
.method public synczsdisassoc_Sta(Ljava/lang/String;)V
    .locals 4
    ...
    const-string/jumbo v3, " disassoc_sta fail : "
