...
.method public run()V
    ...
    const-string/jumbo v3, "cancelNotificationWithTag r.getNotification().flags & mustHaveFlags) != mustHaveFlags "
    ...
    const-string/jumbo v3, " mustHaveFlags "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/server/notification/NotificationManagerService$9;->val$mustHaveFlags:I
    ...
    const-string/jumbo v3, "cancelNotificationWithTag r.getNotification().flags & mustNotHaveFlags) != 0 "
    ...
    const-string/jumbo v3, " mustNotHaveFlags "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/server/notification/NotificationManagerService$9;->val$mustNotHaveFlags:I
