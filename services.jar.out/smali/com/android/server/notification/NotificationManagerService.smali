...
.field final mUidBeep:Landroid/util/SparseBooleanArray;
...
.field private mZsNotificationHelper:Lcom/android/server/notification/ZsNotificationHelper;
...
.method static synthetic -get25(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/ZsNotificationHelper;
    .locals 1

    iget-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->mZsNotificationHelper:Lcom/android/server/notification/ZsNotificationHelper;
...
.method static synthetic -set0(Lcom/android/server/notification/NotificationManagerService;I)I
    ...
    iput p1, p0, Lcom/android/server/notification/NotificationManagerService;->mBatteryStatus:I
...
.method static synthetic -set2(Lcom/android/server/notification/NotificationManagerService;I)I
    ...
    iput p1, p0, Lcom/android/server/notification/NotificationManagerService;->mCallingUid:I

    return p1
.end method

.method static synthetic -set3(Lcom/android/server/notification/NotificationManagerService;Landroid/os/PersistableBundle;)Landroid/os/PersistableBundle;
    .locals 0
...
.method static synthetic -set4(Lcom/android/server/notification/NotificationManagerService;I)I
    ...
    iput p1, p0, Lcom/android/server/notification/NotificationManagerService;->mCurrentBatteryLevel:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->mUidBeep:Landroid/util/SparseBooleanArray;
    ...
    iput-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->mBatteryReceiver:Landroid/content/BroadcastReceiver;
...
.method private cancelNotificationLocked(Lcom/android/server/notification/NotificationRecord;ZI)V
    ...
    const-string/jumbo v15, "cancelNotificationLocked r "

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    invoke-virtual/range {p1 .. p1}, Lcom/android/server/notification/NotificationRecord;->toString()Ljava/lang/String;
    ...
    const-string/jumbo v15, " sendDelete "
...
.method buzzBeepBlinkLocked(Lcom/android/server/notification/NotificationRecord;)V
    ...
    const-string/jumbo v6, "disableEffects="
    ...
    const-string/jumbo v6, " smsRingtone="
    ...
    iget-object v4, v0, Lcom/android/server/notification/NotificationManagerService;->mUidBeep:Landroid/util/SparseBooleanArray;

    move-object/from16 v0, p0

    iget v5, v0, Lcom/android/server/notification/NotificationManagerService;->mCallingUid:I
    ...
    const-string/jumbo v6, "notification hasValidSound="
    ...
    const-string/jumbo v6, " hasValidVibrate="
    ...
    .line 3077
    .local v23, "isRingtoneVibrateOpen":Z
    :goto_e
    if-eqz v22, :cond_a
    ...
    .end local v23    # "isRingtoneVibrateOpen":Z
    ...
    const-string v6, "notification alert status buzz="
    ...
    .restart local v23    # "isRingtoneVibrateOpen":Z
    goto/16 :goto_e
...
.method cancelAllNotificationsInt(IILjava/lang/String;IIZIILcom/android/server/notification/ManagedServices$ManagedServiceInfo;)Z
    ...
    const-string/jumbo v6, "cancelAllNotificationsInt r.getFlags() & mustHaveFlags) != mustHaveFlags "
    ...
    const-string/jumbo v6, " mustHaveFlags "
    ...
    const-string/jumbo v6, "cancelAllNotificationsInt r.getFlags() & mustNotHaveFlags) != 0 "
    ...
    const-string/jumbo v6, " mustNotHaveFlags "
    ...
    const-string/jumbo v6, "cancelAllNotificationsInt r.sbn.getPackageName() "
...
.method public onStart()V
    ...
    iput v1, v0, Lcom/android/server/notification/NotificationManagerService;->mLowBatteryWarningLevel:I
    ...
    .line 1141
    .local v15, "batteryFilter":Landroid/content/IntentFilter;
    ...
    iget-object v2, v0, Lcom/android/server/notification/NotificationManagerService;->mBatteryReceiver:Landroid/content/BroadcastReceiver;
    ...
    .end local v15    # "batteryFilter":Landroid/content/IntentFilter;
...
.method updateLightsLocked()V
    ...
    const-string/jumbo v8, "mCurrentBatteryLevel "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v8, p0, Lcom/android/server/notification/NotificationManagerService;->mCurrentBatteryLevel:I
    ...
    iget v8, p0, Lcom/android/server/notification/NotificationManagerService;->mBatteryStatus:I
    ...
    const-string/jumbo v8, "mLowBatteryWarningLevel "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v8, p0, Lcom/android/server/notification/NotificationManagerService;->mLowBatteryWarningLevel:I
    ...
    const-string/jumbo v7, "ZEUSIS_FEATURE_LOW_BATTERY_LED true"

    invoke-static {v6, v7}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 3800
    :cond_7
    iget v6, p0, Lcom/android/server/notification/NotificationManagerService;->mCurrentBatteryLevel:I

    iget v7, p0, Lcom/android/server/notification/NotificationManagerService;->mLowBatteryWarningLevel:I

    if-gt v6, v7, :cond_8

    iget v6, p0, Lcom/android/server/notification/NotificationManagerService;->mBatteryStatus:I
