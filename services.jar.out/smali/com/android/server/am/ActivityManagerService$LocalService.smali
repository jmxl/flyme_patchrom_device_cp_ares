...
.method public findSplitRemoveId(I)I
    .locals 11
    .param p1, "stackId"    # I
    ...
    iget-object v9, p0, Lcom/android/server/am/ActivityManagerService$LocalService;->this$0:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {v10, p1}, Lcom/android/server/am/ActivityStackSupervisor;->getStack(I)Lcom/android/server/am/ActivityStack;

    move-result-object v2

    .line 24222
    .local v2, "curActivityStack":Lcom/android/server/am/ActivityStack;
    const/4 v1, 0x0
    ...
    invoke-virtual {v7}, Lcom/android/server/am/ActivityStackSupervisor;->getLastResizedTaskRecord()Lcom/android/server/am/ActivityStackSupervisor$LocalTaskList;

    move-result-object v7

    iget v8, v6, Lcom/android/server/am/TaskRecord;->taskId:I

    invoke-virtual {v7, v8}, Lcom/android/server/am/ActivityStackSupervisor$LocalTaskList;->isSplitApp(I)Z
    :try_end_1
    ...
    const-string/jumbo v9, "findSplitRemoveId,nextStackId="
    ...
    .end local v0    # "activities":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/am/ActivityRecord;>;"
    .end local v1    # "ar":Lcom/android/server/am/ActivityRecord;
    .end local v2    # "curActivityStack":Lcom/android/server/am/ActivityStack;
    .end local v3    # "endTask":Z
    .end local v4    # "index":I
    :catchall_0
    move-exception v7
...
.method public getStackIdOfResizedTasked(Landroid/os/IBinder;)I
    .locals 3
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/am/ActivityStackSupervisor;->getStackIdOfResizedTasked(Lcom/android/server/am/ActivityRecord;)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public notifyBackedToHomeStack()V
    .locals 2
    ...
    invoke-virtual {v0}, Lcom/android/server/am/ActivityStackSupervisor;->notifyBackedToHomeStack()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
