...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/am/AppErrors$-java_util_List_sortTracesFile_java_lang_String_path_LambdaImpl0;,
...
# direct methods
.method static synthetic -com_android_server_am_AppErrors_lambda$1(Ljava/io/File;Ljava/io/File;)I
    .locals 4
...
.method private sortTracesFile(Ljava/lang/String;)Ljava/util/List;
    .locals 3
    ...
    .line 988
    .local v1, "files":Ljava/util/List;, "Ljava/util/List<Ljava/io/File;>;"
    new-instance v2, Lcom/android/server/am/AppErrors$-java_util_List_sortTracesFile_java_lang_String_path_LambdaImpl0;

    invoke-direct {v2}, Lcom/android/server/am/AppErrors$-java_util_List_sortTracesFile_java_lang_String_path_LambdaImpl0;-><init>()V
...
.method final appNotResponding(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;ZLjava/lang/String;)V
    ...
    .restart local v22    # "isSilentANR":Z
    goto/16 :goto_2

    .line 818
    .restart local v20    # "i":I
    .restart local v29    # "parentPid":I
    ...
    invoke-static {v4, v5, v6}, Landroid/util/JunkLog;->mark(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v4, v0}, Lcom/android/server/am/ActivityManagerService;->hook_isFreezeAnrNotTrace(Lcom/android/server/am/ProcessRecord;)Z
    ...
    .line 852
    const-string/jumbo v4, "freeze: bg anr"
    ...
    .line 858
    :cond_10
    new-instance v31, Lcom/android/internal/os/ProcessCpuTracker;
    ...
    invoke-virtual {v4, v0, v1}, Lcom/android/server/am/ActivityManagerService;->hook_removeFrozenPids(Ljava/util/ArrayList;Landroid/util/SparseArray;)V
    ...
    .line 886
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/os/ProcessCpuTracker;->printCurrentLoad()Ljava/lang/String;
    ...
    invoke-virtual {v4, v0}, Lcom/android/server/am/ActivityManagerService;->hook_freezeAnrKillLogOut(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-direct {v0, v4}, Lcom/android/server/am/AppErrors;->sortTracesFile(Ljava/lang/String;)Ljava/util/List;

    move-result-object v18

    .line 950
    .local v18, "files":Ljava/util/List;, "Ljava/util/List<Ljava/io/File;>;"
    if-eqz v18, :cond_16
    ...
    .line 969
    .end local v18    # "files":Ljava/util/List;, "Ljava/util/List<Ljava/io/File;>;"
    ...
    .line 971
    .local v25, "map":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Object;>;"
    const/4 v4, 0x2
    ...
    .end local v25    # "map":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Object;>;"
    ...
    .restart local v18    # "files":Ljava/util/List;, "Ljava/util/List<Ljava/io/File;>;"
    ...
    .end local v35    # "traceRenameFile":Ljava/io/File;
    .end local v36    # "tracesPath":Ljava/lang/String;
    .restart local v25    # "map":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Object;>;"
