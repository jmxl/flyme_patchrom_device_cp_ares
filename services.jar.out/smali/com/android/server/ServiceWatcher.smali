...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;IIILjava/lang/Runnable;Landroid/os/Handler;)V
    ...
    iput v6, p0, Lcom/android/server/ServiceWatcher;->mCurrentUserId:I

    .line 83
    const/high16 v6, -0x80000000

    iput v6, p0, Lcom/android/server/ServiceWatcher;->mBoundVersion:I

    .line 85
    const/16 v6, -0x2710

    iput v6, p0, Lcom/android/server/ServiceWatcher;->mBoundUserId:I
...
.method private bindBestPackageLocked(Ljava/lang/String;Z)Z
    ...
    const-string/jumbo v20, "bindBestPackage for %s : %s found %d, %s"
    ...
    const-string/jumbo v18, "no new best component"
    ...
    .line 251
    .restart local v14    # "rInfo$iterator":Ljava/util/Iterator;
    :cond_5
    ...
    const-string/jumbo v22, "new best component: "
    ...
    const-string/jumbo v20, "Unable to query intent services for action: "
