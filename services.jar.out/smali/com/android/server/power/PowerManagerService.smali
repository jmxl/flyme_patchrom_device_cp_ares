...
.field private static final MSG_LED_LIGHT_OFF:I = 0x5

.field private static final MSG_RESET_FORCE_SCREEN_ON:I = 0x6
...
# instance fields
.field private mAcquireWakeLockBlacklistDoze:[I
...
.field private mForceScreenOn:Z

.field private mGmsAppBlacklist:[Ljava/lang/String;
...
.method static synthetic -get0(Lcom/android/server/power/PowerManagerService;)I
    ...
    iget v0, p0, Lcom/android/server/power/PowerManagerService;->mBtnLightBrightness:I
...
.method static synthetic -get1(Lcom/android/server/power/PowerManagerService;)I
    ...
    iget v0, p0, Lcom/android/server/power/PowerManagerService;->mBtnLightTime:I
...
.method static synthetic -get16(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/QCNsrmPowerExtension;
    .locals 1
...
.method static synthetic -get6(Lcom/android/server/power/PowerManagerService;)Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;
    .locals 1
...
.method static synthetic -get9(Lcom/android/server/power/PowerManagerService;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mForceScreenOn:Z
...
.method static synthetic -wrap13(Lcom/android/server/power/PowerManagerService;)V
    ...
    invoke-direct {p0}, Lcom/android/server/power/PowerManagerService;->handleResetForceScreenOn()V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 268
    iput v1, p0, Lcom/android/server/power/PowerManagerService;->mGoToSleepReason:I
    ...
    iput-object v0, p0, Lcom/android/server/power/PowerManagerService;->mAcquireWakeLockBlacklistDoze:[I
    ...
    .line 536
    iput-object v0, p0, Lcom/android/server/power/PowerManagerService;->mGmsAppBlacklist:[Ljava/lang/String;

    .line 1285
    iput-boolean v3, p0, Lcom/android/server/power/PowerManagerService;->mForceScreenOn:Z
...
.method private acquireWakeLockInternal(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;Ljava/lang/String;II)V
    ...
    .line 934
    :try_start_0
    invoke-static {}, Landroid/os/ZsPowerMonitorProxy;->isBetaMode()Z
    ...
    const-string/jumbo v4, "acquireWakeLockInternal: lock="
...
.method private checkIsImportantWakeLock(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    .locals 4
    .param p1, "wakeLock"    # Lcom/android/server/power/PowerManagerService$WakeLock;
...
.method private checkWorkSourceMatch([ILcom/android/server/power/PowerManagerService$WakeLock;)I
    .locals 6
    .param p1, "appids"    # [I
    ...
    .local v1, "i":I
    :goto_1
    iget-object v3, p0, Lcom/android/server/power/PowerManagerService;->mAcquireWakeLockBlacklistDoze:[I
    ...
    iget-object v4, p2, Lcom/android/server/power/PowerManagerService$WakeLock;->mWorkSource:Landroid/os/WorkSource;

    invoke-virtual {v4, v2}, Landroid/os/WorkSource;->get(I)I
...
.method private handleResetForceScreenOn()V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mForceScreenOn:Z
...
.method private handleUserActivityTimeout()V
    ...
    .line 1923
    const-string/jumbo v0, "POWER0002"

    invoke-static {v0}, Landroid/os/ZsPowerMonitorProxy;->isMonitorEnabled(Ljava/lang/String;)Z
    ...
    const-string/jumbo v3, "screen will not off due to "
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/power/PowerManagerService;->getEarliestWakeLockImpl(I)Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Landroid/os/ZsPowerMonitorProxy;->mark(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private initialBlackListDozeLocked()V
    .locals 10
    ...
    .line 2945
    .local v5, "mGmsAppInfos":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    invoke-virtual {p0}, Lcom/android/server/power/PowerManagerService;->getContext()Landroid/content/Context;
    ...
    .local v4, "i":I
    :goto_0
    iget-object v8, p0, Lcom/android/server/power/PowerManagerService;->mGmsAppBlacklist:[Ljava/lang/String;
    ...
    .line 2962
    :cond_1
    iput-object v2, p0, Lcom/android/server/power/PowerManagerService;->mAcquireWakeLockBlacklistDoze:[I

    .line 2963
    iget-object v8, p0, Lcom/android/server/power/PowerManagerService;->mAcquireWakeLockBlacklistDoze:[I

    invoke-static {v8}, Ljava/util/Arrays;->sort([I)V

    .line 2943
    .end local v2    # "appids":[I
    .end local v4    # "i":I
    :cond_2
    return-void
...
.method private notifyWakeLockLongFinishedLocked(Lcom/android/server/power/PowerManagerService$WakeLock;)V
    ...
    .line 1153
    iput-boolean v5, p1, Lcom/android/server/power/PowerManagerService$WakeLock;->mNotifiedLong:Z
    ...
    .line 1158
    :cond_0
    iget-boolean v0, p1, Lcom/android/server/power/PowerManagerService$WakeLock;->mReportedLong:Z

    if-eqz v0, :cond_1

    .line 1159
    iput-boolean v5, p1, Lcom/android/server/power/PowerManagerService$WakeLock;->mReportedLong:Z
...
.method private releaseWakeLockInternal(Landroid/os/IBinder;I)V
    ...
    const-string/jumbo v7, "releaseWakeLockInternal: lock="
    ...
    .line 1019
    const-string/jumbo v7, " [not found], flags=0x"
    ...
    iget-wide v8, v3, Lcom/android/server/power/PowerManagerService$WakeLock;->mCreateTime:J

    sub-long v0, v6, v8

    .line 1030
    .local v0, "holdDuration":J
    const-string/jumbo v4, "PowerManagerService"
    ...
    .line 1032
    const-string/jumbo v7, ", holdDuration="
    ...
    .line 1040
    invoke-direct {p0, v3, v2}, Lcom/android/server/power/PowerManagerService;->removeWakeLockLocked(Lcom/android/server/power/PowerManagerService$WakeLock;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private setWakeLockDisableStatesBlackListLocked(Lcom/android/server/power/PowerManagerService$WakeLock;Z)Z
    .locals 8
    .param p1, "wakeLock"    # Lcom/android/server/power/PowerManagerService$WakeLock;
    .param p2, "checkWorkSource"    # Z
    ...
    .line 2879
    .local v2, "disabled":Z
    invoke-direct {p0, p1}, Lcom/android/server/power/PowerManagerService;->checkIsImportantWakeLock(Lcom/android/server/power/PowerManagerService$WakeLock;)Z
    ...
    .line 2885
    .local v1, "appidWorkSource":I
    iget-object v3, p1, Lcom/android/server/power/PowerManagerService$WakeLock;->mWorkSource:Landroid/os/WorkSource;

    .line 2886
    .local v3, "ws":Landroid/os/WorkSource;
    iget-object v4, p0, Lcom/android/server/power/PowerManagerService;->mAcquireWakeLockBlacklistDoze:[I
    ...
    invoke-direct {p0, v4, p1}, Lcom/android/server/power/PowerManagerService;->checkWorkSourceMatch([ILcom/android/server/power/PowerManagerService$WakeLock;)I
    ...
    .end local v1    # "appidWorkSource":I
    ...
    .restart local v1    # "appidWorkSource":I
    .restart local v3    # "ws":Landroid/os/WorkSource;
    :cond_4
    move v1, v0
...
.method private updateAcquireWakeLockBlacklistDozeLocked(Z)V
    .locals 6
    .param p1, "checkWorkSource"    # Z
    ...
    .line 2858
    invoke-direct {p0, v3, p1}, Lcom/android/server/power/PowerManagerService;->setWakeLockDisableStatesBlackListLocked(Lcom/android/server/power/PowerManagerService$WakeLock;Z)Z
...
.method private updateAppWakeLockStatesLocked(ILjava/lang/String;Z)V
    .locals 7
    .param p1, "uid"    # I
...
.method private updateDisplayPowerStateLocked(I)Z
    ...
    iput v8, v5, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->policy:I
    ...
    iput v4, v5, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->screenBrightness:I

    .line 2251
    iget-object v5, p0, Lcom/android/server/power/PowerManagerService;->mDisplayPowerRequest:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;

    iput v3, v5, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->screenAutoBrightnessAdjustment:F

    .line 2253
    iget-object v5, p0, Lcom/android/server/power/PowerManagerService;->mDisplayPowerRequest:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;

    iput-boolean v1, v5, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->brightnessSetByUser:Z

    .line 2254
    iget-object v5, p0, Lcom/android/server/power/PowerManagerService;->mDisplayPowerRequest:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;

    iput-boolean v0, v5, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->useAutoBrightness:Z
    ...
    iget-boolean v5, p0, Lcom/android/server/power/PowerManagerService;->mForceScreenOn:Z
    ...
    :goto_3
    iput-boolean v5, v8, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->useProximitySensor:Z
    ...
    iput-boolean v8, v5, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->lowPowerMode:Z
    ...
    iput-boolean v8, v5, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->boostScreenBrightness:Z
    ...
    iput-boolean v8, v5, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->useTwilight:Z

    .line 2262
    iget-object v5, p0, Lcom/android/server/power/PowerManagerService;->mDisplayPowerRequest:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;

    iget v8, p0, Lcom/android/server/power/PowerManagerService;->mGoToSleepReason:I

    iput v8, v5, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->goToSleepReason:I
    ...
    iput v8, v5, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->dozeScreenState:I
    ...
    .line 2270
    iput v8, v5, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->dozeScreenBrightness:I
    ...
    .line 2277
    invoke-virtual {v5, v8, v9}, Landroid/hardware/display/DisplayManagerInternal;->requestPowerState(Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;Z)Z
...
.method private updateSettingsLocked()V
    ...
    .line 792
    const-string/jumbo v8, "sleep_timeout"
    ...
    iput v8, p0, Lcom/android/server/power/PowerManagerService;->mBtnLightTime:I
    ...
    iput v8, p0, Lcom/android/server/power/PowerManagerService;->mBtnLightBrightness:I
    ...
    .line 810
    const-string/jumbo v8, "double_tap_to_wake"
    ...
    .line 821
    .local v5, "oldScreenBrightnessMode":I
    ...
    invoke-virtual {v8}, Landroid/hardware/display/DisplayManagerInternal;->getScreenAutoBrightness()I
    ...
    invoke-static {v8, v11, v1}, Landroid/provider/Settings$System;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z
    ...
    const-string/jumbo v8, "screen_auto_brightness_adj"
    ...
    .line 855
    :cond_3
    const-string/jumbo v8, "brightness_use_twilight"
    ...
    :goto_9
    iput-boolean v9, p0, Lcom/android/server/power/PowerManagerService;->mBrightnessUseTwilight:Z

    .line 858
    const-string/jumbo v8, "low_power"
    ...
    :goto_a
    const-string/jumbo v8, "low_power_trigger_level"
    ...
    .end local v5    # "oldScreenBrightnessMode":I
    ...
    .restart local v5    # "oldScreenBrightnessMode":I
...
.method private updateWakeLockSummaryLocked(I)V
    ...
    .line 1746
    iget v3, p0, Lcom/android/server/power/PowerManagerService;->mGoToSleepReason:I
...
.method private wakeUpNoUpdateLocked(JLjava/lang/String;ILjava/lang/String;I)Z
    ...
    iput v0, p0, Lcom/android/server/power/PowerManagerService;->mGoToSleepReason:I
...
.method checkForLongWakeLocks()V
    ...
    invoke-virtual {v0, v12, v10, v11}, Lcom/android/server/power/PowerManagerService;->reportLongWakeLock(Lcom/android/server/power/PowerManagerService$WakeLock;J)V
...
.method getAcquireWakeLockBlacklistDozeInternal()[I
    .locals 2
    ...
    .line 2740
    :try_start_0
    iget-object v1, p0, Lcom/android/server/power/PowerManagerService;->mAcquireWakeLockBlacklistDoze:[I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getAllWakeLocksImpl()Ljava/lang/String;
    .locals 10
    ...
    .line 4367
    :try_start_0
    const-string/jumbo v3, "Wake Locks:"
    ...
    iget v4, v5, Lcom/android/server/power/PowerManagerService$WakeLock;->mOwnerUid:I

    .line 4373
    .local v4, "uid":I
    iget-object v1, v5, Lcom/android/server/power/PowerManagerService$WakeLock;->mPackageName:Ljava/lang/String;
    ...
    invoke-virtual {v6, v7}, Landroid/os/WorkSource;->get(I)I
    ...
    invoke-virtual {v6, v7}, Landroid/os/WorkSource;->getName(I)Ljava/lang/String;
    ...
    invoke-virtual {v2, v4}, Landroid/content/pm/PackageManagerInternal;->getPackageForUid(I)Ljava/lang/String;
    ...
    const-string/jumbo v9, ", [mReportedLong:"

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-boolean v9, v5, Lcom/android/server/power/PowerManagerService$WakeLock;->mReportedLong:Z
...
.method public getEarliestWakeLockImpl(I)Ljava/lang/String;
    .locals 10
    .param p1, "flags"    # I
    ...
    .line 4396
    iget v2, v3, Lcom/android/server/power/PowerManagerService$WakeLock;->mOwnerUid:I

    .line 4397
    .local v2, "uid":I
    iget-object v0, v3, Lcom/android/server/power/PowerManagerService$WakeLock;->mPackageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/power/PowerManagerService;->getLocalService(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v2}, Landroid/content/pm/PackageManagerInternal;->getPackageForUid(I)Ljava/lang/String;
    ...
    const-string/jumbo v8, " hold LOCK:"
    ...
    .end local v5    # "ws":Landroid/os/WorkSource;
    :cond_3
    monitor-exit v7
...
.method public reportLongWakeLock(Lcom/android/server/power/PowerManagerService$WakeLock;J)V
    .locals 12
    .param p1, "wakeLock"    # Lcom/android/server/power/PowerManagerService$WakeLock;
    .param p2, "now"    # J
    ...
    .line 4416
    const-string/jumbo v6, "POWER0009"

    invoke-static {v6}, Landroid/os/ZsPowerMonitorProxy;->isMonitorEnabled(Ljava/lang/String;)Z
    ...
    .line 4417
    iget-boolean v6, p1, Lcom/android/server/power/PowerManagerService$WakeLock;->mNotifiedAcquired:Z

    .line 4416
    if-eqz v6, :cond_0

    .line 4417
    iget-boolean v6, p1, Lcom/android/server/power/PowerManagerService$WakeLock;->mReportedLong:Z
    ...
    invoke-static {v6}, Landroid/os/ZsPowerMonitorProxy;->getMonitorParam(Ljava/lang/String;)J
    ...
    iput-boolean v6, p1, Lcom/android/server/power/PowerManagerService$WakeLock;->mReportedLong:Z
    ...
    .line 4426
    invoke-virtual {v5, v10}, Landroid/os/WorkSource;->get(I)I

    move-result v4

    .line 4427
    invoke-virtual {v5, v10}, Landroid/os/WorkSource;->getName(I)Ljava/lang/String;
    ...
    invoke-virtual {v3, v4}, Landroid/content/pm/PackageManagerInternal;->getPackageForUid(I)Ljava/lang/String;
    ...
    const-string/jumbo v8, "] exceeded the longest acquire time. ["
    ...
    .line 4433
    invoke-static {v6, v7}, Landroid/os/ZsPowerMonitorProxy;->mark(Ljava/lang/String;Ljava/lang/String;)V
...
.method updateAcquireWakeLockBlacklistDozeInternal([I)V
    .locals 2
    .param p1, "appIds"    # [I
    ...
    .line 2727
    :try_start_0
    iput-object p1, p0, Lcom/android/server/power/PowerManagerService;->mAcquireWakeLockBlacklistDoze:[I

    .line 2728
    iget-object v0, p0, Lcom/android/server/power/PowerManagerService;->mAcquireWakeLockBlacklistDoze:[I
    ...
    invoke-direct {p0, v0}, Lcom/android/server/power/PowerManagerService;->updateAcquireWakeLockBlacklistDozeLocked(Z)V
...
.method updateAppWakeLockStateInternal(ILjava/lang/String;Z)V
    .locals 2
    .param p1, "uid"    # I
    .param p2, "packageName"    # Ljava/lang/String;
    .param p3, "disable"    # Z
    ...
    .line 2721
    :try_start_0
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/power/PowerManagerService;->updateAppWakeLockStatesLocked(ILjava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
