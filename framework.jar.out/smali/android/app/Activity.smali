...
.field private mShouldChangeStatusBarColor:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/app/Activity;->mServiceAquireLock:Ljava/lang/Object;
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v5, v1}, Landroid/util/BoostFramework;->touchBoostOverride(Landroid/content/Context;)Z
    ...
    sget-object v7, Landroid/app/Activity;->mAsParamVal:[I

    .line 3173
    invoke-virtual {v5, v6, v7}, Landroid/util/BoostFramework;->perfLockAcquire(I[I)I
...
.method getStatusBarService()Lcom/android/internal/statusbar/IStatusBarService;
    ...
    .prologue
    .line 1263
    iget-object v1, p0, Landroid/app/Activity;->mServiceAquireLock:Ljava/lang/Object;

    monitor-enter v1

    .line 1264
    :try_start_0
    iget-object v0, p0, Landroid/app/Activity;->mStatusBarService:Lcom/android/internal/statusbar/IStatusBarService;
    ...
    iput-object v0, p0, Landroid/app/Activity;->mStatusBarService:Lcom/android/internal/statusbar/IStatusBarService;
...
.method public isActivatedMode()Z
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v0, v1}, Landroid/app/IActivityManager;->isActivatedMode(Landroid/os/IBinder;)Z
...
.method protected onResume()V
    ...
    .prologue
    .line 1294
    invoke-virtual {p0}, Landroid/app/Activity;->getStatusBarService()Lcom/android/internal/statusbar/IStatusBarService;
    ...
    .line 1299
    :try_start_0
    invoke-virtual {p0}, Landroid/app/Activity;->shouldChangeStatusBarColor()Z
    ...
    invoke-interface {v1, v3, v4}, Lcom/android/internal/statusbar/IStatusBarService;->onStatusBarColorChanged(ILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v3, p0}, Landroid/app/Application;->dispatchActivityResumed(Landroid/app/Activity;)V
    ...
    invoke-virtual {v3, p0, v4}, Landroid/app/ActivityTransitionState;->onResume(Landroid/app/Activity;Z)V
...
.method public setActivatedMode(Z)V
    .locals 2
    ...
    invoke-interface {v0, v1, p1}, Landroid/app/IActivityManager;->setActivatedMode(Landroid/os/IBinder;Z)V
...
.method protected shouldChangeStatusBarColor()Z
    .locals 4
    ...
    .line 7323
    :try_start_0
    invoke-virtual {p0}, Landroid/app/Activity;->getWindowStackId()I
    ...
    iput-boolean v2, p0, Landroid/app/Activity;->mShouldChangeStatusBarColor:Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_0
    iget-boolean v2, p0, Landroid/app/Activity;->mShouldChangeStatusBarColor:Z
...
.method public startActivity(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    .line 4640
    invoke-virtual {p0, p1, v2, p2}, Landroid/app/Activity;->startActivityForResult(Landroid/content/Intent;ILandroid/os/Bundle;)V
...
.method public switchFloatedAndBackground()V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {v0, v1}, Landroid/app/IActivityManager;->switchFloatedAndBackground(Landroid/os/IBinder;)V
