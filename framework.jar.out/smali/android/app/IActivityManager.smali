...
.field public static final CAN_GO_IN_DOCKED_STACK_TRANSACTION:I = 0x1f9

.field public static final CAN_SHOW_FLOATED_BUTTON_TRANSACTION:I = 0x1fe

.field public static final CAN_SHOW_SPLIT_BUTTON_TRANSACTION:I = 0x1fa
...
.field public static final ENABLE_FLOATED_WINDOW_TRANSACTION:I = 0x1ff
...
.field public static final FORCE_FREEZE_PACKAGE_TRANSACTION:I = 0x17e

.field public static final FORCE_STOP_PACKAGE_TRANSACTION:I = 0x4f

.field public static final FORCE_UNFREEZE_PACKAGE_TRANSACTION:I = 0x17f

.field public static final FREEZE_REGISTER_LISTENER_TRANSACTION:I = 0x180

.field public static final GET_ACTIVATED_MODE_TRANSACTION:I = 0x1f8
...
.field public static final GET_ALL_RESIZED_TASK_INFOS_TRANSACTION:I = 0x1f5
...
.field public static final GET_BACKGTOUND_TASK_INFO_TRANSACTION:I = 0x206
...
.field public static final GET_EXCLUDED_RESIZED_TASKS_TRANSACTION:I = 0x20b
...
.field public static final GET_PENDINGINTENT_USERID:I = 0x181
...
.field public static final GET_RECENT_DOCKABLE_TASKS_TRANSACTION:I = 0x1fc
...
.field public static final GET_RESIZED_TASK_INFO_TRANSACTION:I = 0x1f6
...
.field public static final GET_STACKID_OF_RESIZED_INTENT_TRANSACTION:I = 0x205
...
.field public static final GET_TASKS_EXCLUDE_STACKID_TRANSACTION:I = 0x1fb
...
.field public static final GET_TOP_TASKS_OF_STACKID_TRANSACTION:I = 0x1fd
...
.field public static final IS_FLOATED_WINDOW_ENABLE_TRANSACTION:I = 0x200
...
.field public static final IS_PROCESS_SHOWN_SYSTEM_ALERTWINDOW:I = 0x183
...
.field public static final JOS_MOVE_TASK_TO_DOCKED_STACK_TRANSACTION:I = 0x20d
...
.field public static final KILL_PROCESSES_WITH_TAG_TRANSACTION:I = 0xbc
...
.field public static final NOTIFY_SPLIT_EXIT_ANIMATION_ENDED_TRANSACTION:I = 0x20c
...
.field public static final RESET_FORCEFULLSCREEN_TRANSACTION:I = 0x203
...
.field public static final SET_ACTIVATED_MODE_TRANSACTION:I = 0x1f7
...
.field public static final SET_FLOATED_ACTIVATE_MODE_TRANSACTION:I = 0x201
...
.field public static final SWITCH_FLOATED_AND_BACKGROUND_TRANSACTION:I = 0x204
...
.field public static final UPDATE_RESIZED_TASK_INFOS_TRANSACTION:I = 0x202

.field public static final UPDATE_SYSTEM_ALERTWINDOW_LIST:I = 0x182
...
.method public abstract canGoInDockedStack(Landroid/content/IIntentSender;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract canShowFloatedButton(Landroid/content/IIntentSender;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract canShowSplitButton(Landroid/content/IIntentSender;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract enableFloatedWindow(Z)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract freezeRegisterListener(Landroid/os/freeze/IYLAppFreezeListener;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getAllResizedTaskInfos()Ljava/util/List;
...
.method public abstract getBackgroundTaskInfo(Ljava/lang/String;Ljava/lang/String;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getExcludedResizedTasks()Landroid/content/pm/ParceledListSlice;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public abstract getPendingIntentUserId(Landroid/app/PendingIntent;)I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getRecentDockableTasks(II)Landroid/content/pm/ParceledListSlice;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(II)",
            "Landroid/content/pm/ParceledListSlice",
...
.method public abstract getResizedTaskInfo(I)Landroid/app/ActivityManager$ResizedTaskInfo;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getStackIdOfResizedIntent(Landroid/content/IIntentSender;)I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getTasksExcludeStackId(III)Landroid/content/pm/ParceledListSlice;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(III)",
            "Landroid/content/pm/ParceledListSlice",
...
.method public abstract getTopTasksOfStackId(IIII)Landroid/content/pm/ParceledListSlice;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IIII)",
            "Landroid/content/pm/ParceledListSlice",
...
.method public abstract isActivatedMode(Landroid/os/IBinder;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract isFloatedWindowEnable()Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract isProcessShownSystemAlertWindow(Ljava/lang/String;I)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract killProcessesWithTag(Ljava/lang/String;I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract moveTaskToDockedStack(IIZZLandroid/graphics/Rect;ZZ)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract notifySplitExitAnimationEnded()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract resetForceFullScreen()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setActivatedMode(Landroid/os/IBinder;Z)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract setFloatedActivatedMode(Z)I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract switchFloatedAndBackground(Landroid/os/IBinder;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract updateResizedTaskInfo(IIZ)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract updateSystemAlertWindowList(Ljava/lang/String;IIII)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
