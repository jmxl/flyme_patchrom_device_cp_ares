...
.field static final TRANSACTION_forceCloseAppLocation:I = 0x23
...
.field static final TRANSACTION_getMaxGpsUsagePackage:I = 0x28
...
.field static final TRANSACTION_isGPSUsingPkgName:I = 0x26

.field static final TRANSACTION_isProviderEnabled:I = 0x17

.field static final TRANSACTION_isRevomedByLBSFeature:I = 0x27
...
.field static final TRANSACTION_restoreAppLocation:I = 0x24

.field static final TRANSACTION_sendExtraCommand:I = 0x20

.field static final TRANSACTION_sendNiResponse:I = 0xb

.field static final TRANSACTION_setGpsProviderListener:I = 0x25
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    check-cast v50, Landroid/location/LocationRequest;
    ...
    .line 63
    .local v54, "_arg1":Landroid/location/ILocationListener;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    check-cast v59, Landroid/app/PendingIntent;
    ...
    .line 71
    .local v61, "_arg3":Ljava/lang/String;
    ...
    .line 58
    .end local v54    # "_arg1":Landroid/location/ILocationListener;
    .end local v61    # "_arg3":Ljava/lang/String;
    :cond_0
    const/16 v50, 0x0

    .local v50, "_arg0":Landroid/location/LocationRequest;
    goto :goto_0

    .line 67
    .end local v50    # "_arg0":Landroid/location/LocationRequest;
    .restart local v54    # "_arg1":Landroid/location/ILocationListener;
    :cond_1
    const/16 v59, 0x0

    .local v59, "_arg2":Landroid/app/PendingIntent;
    goto :goto_1

    .line 77
    .end local v54    # "_arg1":Landroid/location/ILocationListener;
    .end local v59    # "_arg2":Landroid/app/PendingIntent;
    :sswitch_2
    const-string/jumbo v7, "android.location.ILocationManager"
    ...
    .line 81
    .local v48, "_arg0":Landroid/location/ILocationListener;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 89
    .local v60, "_arg2":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 85
    .end local v60    # "_arg2":Ljava/lang/String;
    :cond_2
    const/16 v51, 0x0

    .local v51, "_arg1":Landroid/app/PendingIntent;
    goto :goto_2

    .line 95
    .end local v48    # "_arg0":Landroid/location/ILocationListener;
    .end local v51    # "_arg1":Landroid/app/PendingIntent;
    :sswitch_3
    const-string/jumbo v7, "android.location.ILocationManager"
    ...
    check-cast v53, Landroid/location/Geofence;
    ...
    .line 119
    .restart local v61    # "_arg3":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .restart local v50    # "_arg0":Landroid/location/LocationRequest;
    goto :goto_3
    ...
    .local v53, "_arg1":Landroid/location/Geofence;
    goto :goto_4

    .line 115
    .end local v53    # "_arg1":Landroid/location/Geofence;
    :cond_5
    const/16 v59, 0x0

    .restart local v59    # "_arg2":Landroid/app/PendingIntent;
    goto :goto_5
    ...
    .line 142
    .restart local v60    # "_arg2":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .restart local v51    # "_arg1":Landroid/app/PendingIntent;
    goto :goto_7
    ...
    .line 158
    .local v57, "_arg1":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 159
    .local v63, "_result":Landroid/location/Location;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 154
    .end local v57    # "_arg1":Ljava/lang/String;
    .end local v63    # "_result":Landroid/location/Location;
    :cond_8
    const/16 v50, 0x0
    ...
    .line 165
    .end local v50    # "_arg0":Landroid/location/LocationRequest;
    .restart local v57    # "_arg1":Ljava/lang/String;
    .restart local v63    # "_result":Landroid/location/Location;
    :cond_9
    const/4 v7, 0x0
    ...
    .line 175
    .local v46, "_arg0":Landroid/location/IGnssStatusListener;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 183
    .end local v46    # "_arg0":Landroid/location/IGnssStatusListener;
    .end local v57    # "_arg1":Ljava/lang/String;
    ...
    .line 186
    .restart local v46    # "_arg0":Landroid/location/IGnssStatusListener;
    move-object/from16 v0, p0
    ...
    .line 270
    .local v44, "_arg0":Landroid/location/IGnssMeasurementsListener;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 278
    .end local v44    # "_arg0":Landroid/location/IGnssMeasurementsListener;
    .end local v57    # "_arg1":Ljava/lang/String;
    .end local v67    # "_result":Z
    :sswitch_d
    const-string/jumbo v7, "android.location.ILocationManager"
    ...
    .line 281
    .restart local v44    # "_arg0":Landroid/location/IGnssMeasurementsListener;
    move-object/from16 v0, p0
    ...
    .line 291
    .local v45, "_arg0":Landroid/location/IGnssNavigationMessageListener;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 299
    .end local v45    # "_arg0":Landroid/location/IGnssNavigationMessageListener;
    .end local v57    # "_arg1":Ljava/lang/String;
    .end local v67    # "_result":Z
    :sswitch_f
    const-string/jumbo v7, "android.location.ILocationManager"
    ...
    .line 302
    .restart local v45    # "_arg0":Landroid/location/IGnssNavigationMessageListener;
    move-object/from16 v0, p0
    ...
    check-cast v52, Landroid/location/Criteria;
    ...
    .local v52, "_arg1":Landroid/location/Criteria;
    goto :goto_15

    .line 370
    .end local v52    # "_arg1":Landroid/location/Criteria;
    .restart local v67    # "_result":Z
    :cond_16
    const/4 v7, 0x0
    ...
    .line 379
    .local v64, "_result":Lcom/android/internal/location/ProviderProperties;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 391
    .end local v17    # "_arg0":Ljava/lang/String;
    .end local v64    # "_result":Lcom/android/internal/location/ProviderProperties;
    :sswitch_16
    const-string/jumbo v7, "android.location.ILocationManager"
    ...
    check-cast v56, Lcom/android/internal/location/ProviderProperties;
    ...
    .local v56, "_arg1":Lcom/android/internal/location/ProviderProperties;
    goto :goto_19

    .line 427
    .end local v17    # "_arg0":Ljava/lang/String;
    .end local v56    # "_arg1":Lcom/android/internal/location/ProviderProperties;
    :sswitch_19
    const-string/jumbo v7, "android.location.ILocationManager"
    ...
    check-cast v55, Landroid/location/Location;
    ...
    .local v55, "_arg1":Landroid/location/Location;
    goto :goto_1a

    .line 456
    .end local v17    # "_arg0":Ljava/lang/String;
    .end local v55    # "_arg1":Landroid/location/Location;
    :sswitch_1b
    const-string/jumbo v7, "android.location.ILocationManager"
    ...
    .local v49, "_arg0":Landroid/location/Location;
    goto :goto_20

    .line 559
    .end local v49    # "_arg0":Landroid/location/Location;
    :cond_21
    const/16 v58, 0x0
    ...
    .line 569
    .restart local v48    # "_arg0":Landroid/location/ILocationListener;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v1, v2}, Landroid/location/ILocationManager$Stub;->forceCloseAppLocation(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v1}, Landroid/location/ILocationManager$Stub;->restoreAppLocation(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Landroid/location/IGpsProviderListener$Stub;->asInterface(Landroid/os/IBinder;)Landroid/location/IGpsProviderListener;

    move-result-object v47

    .line 598
    .local v47, "_arg0":Landroid/location/IGpsProviderListener;
    move-object/from16 v0, p0

    move-object/from16 v1, v47

    invoke-virtual {v0, v1}, Landroid/location/ILocationManager$Stub;->setGpsProviderListener(Landroid/location/IGpsProviderListener;)V
    ...
    .line 604
    .end local v47    # "_arg0":Landroid/location/IGpsProviderListener;
    :sswitch_26
    const-string/jumbo v7, "android.location.ILocationManager"
    ...
    invoke-virtual {v0, v1}, Landroid/location/ILocationManager$Stub;->isGPSUsingPkgName(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v1}, Landroid/location/ILocationManager$Stub;->isRevomedByLBSFeature(Ljava/lang/String;)Z
    ...
    .line 631
    invoke-virtual/range {v37 .. v43}, Landroid/location/ILocationManager$Stub;->getMaxGpsUsagePackage(JJJ)Ljava/lang/String;
