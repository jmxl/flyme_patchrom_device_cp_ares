...
.field final mUidApfMobilePolicy:Landroid/util/SparseIntArray;

.field final mUidApfWifiPolicy:Landroid/util/SparseIntArray;
...
.field final mUidMobilePolicy:Landroid/util/SparseBooleanArray;
...
.field final mUidWifiPolicy:Landroid/util/SparseBooleanArray;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;Landroid/net/INetworkStatsService;Landroid/os/INetworkManagementService;Landroid/util/TrustedTime;Ljava/io/File;Z)V
    ...
    iput-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidApfMobilePolicy:Landroid/util/SparseIntArray;
    ...
    iput-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidApfWifiPolicy:Landroid/util/SparseIntArray;
    ...
    iput-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidWifiPolicy:Landroid/util/SparseBooleanArray;
    ...
    iput-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidMobilePolicy:Landroid/util/SparseBooleanArray;
...
.method private removeRestrictBackgroundWhitelistedUidUL(IZZ)Z
    ...
    .line 2272
    invoke-virtual {p0, p1, p2}, Lcom/android/server/net/NetworkPolicyManagerService;->updateRulesForDataUsageRestrictionsUL(IZ)V
...
.method private removeUidAppfreezePolicyUncheckedLocked(ILjava/lang/String;Z)V
    .locals 5
    .param p1, "uid"    # I
    ...
    .prologue
    .line 1884
    const-string/jumbo v3, "apf_wifi"

    if-ne p2, v3, :cond_1

    .line 1885
    iget-object v3, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidApfWifiPolicy:Landroid/util/SparseIntArray;
    ...
    invoke-interface {v3, p1, p2, v0}, Landroid/os/INetworkManagementService;->setAppfreezeFirewallUidChainRule(ILjava/lang/String;Z)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    .end local v0    # "drop":Z
    :cond_1
    iget-object v3, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidApfMobilePolicy:Landroid/util/SparseIntArray;
...
.method private setUidAppfreezePolicyUncheckedLocked(IILjava/lang/String;Z)V
    .locals 6
    .param p1, "uid"    # I
    .param p2, "policy"    # I
    .param p3, "chain"    # Ljava/lang/String;
    .param p4, "persist"    # Z
    ...
    const-string/jumbo v5, "setUidAppfreezePolicyUncheckedLocked--uid:"
    ...
    invoke-interface {v3, p1, p3, v0}, Landroid/os/INetworkManagementService;->setAppfreezeFirewallUidChainRule(ILjava/lang/String;Z)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
...
.method private setUidNetworkUncheckedLocked(IIZZ)V
    .locals 4
    .param p1, "uid"    # I
    .param p2, "type"    # I
    .param p3, "enable"    # Z
    ...
    invoke-interface {v2, p1, p2, p3}, Landroid/os/INetworkManagementService;->setUidEnableNetwork(IIZ)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
...
.method private updateRulesForDataUsageRestrictionsUL(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/net/NetworkPolicyManagerService;->updateRulesForDataUsageRestrictionsUL(IZ)V
...
.method public isUidEnableNetwork(II)Z
    ...
    .line 3835
    :try_start_0
    iget-object v0, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidMobilePolicy:Landroid/util/SparseBooleanArray;
    ...
    :cond_2
    :try_start_1
    iget-object v0, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidWifiPolicy:Landroid/util/SparseBooleanArray;
...
.method public setUidAppfreezePolicy(IILjava/lang/String;)V
    .locals 8
    .param p1, "uid"    # I
    .param p2, "policy"    # I
    .param p3, "chain"    # Ljava/lang/String;
    ...
    const-string/jumbo v6, "cannot apply policy to UID "
    ...
    .line 1749
    .local v0, "enterNextStage":Z
    :try_start_1
    const-string/jumbo v4, "apf_wifi"

    if-ne p3, v4, :cond_4

    .line 1750
    iget-object v4, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidApfWifiPolicy:Landroid/util/SparseIntArray;
    ...
    const-string/jumbo v7, "setUidAppfreezePolicy--uid:"
    ...
    const-string/jumbo v7, " is started for the first time!"
    ...
    invoke-direct {p0, p1, p2, p3, v4}, Lcom/android/server/net/NetworkPolicyManagerService;->setUidAppfreezePolicyUncheckedLocked(IILjava/lang/String;Z)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_4
    :try_start_3
    iget-object v4, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidApfMobilePolicy:Landroid/util/SparseIntArray;
...
.method public setUidEnableNetwork(IIZ)V
    ...
    const-string/jumbo v5, "Invalid network type "
    ...
    .line 3807
    :try_start_1
    iget-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidMobilePolicy:Landroid/util/SparseBooleanArray;
    ...
    invoke-direct {p0, p1, p2, p3, v1}, Lcom/android/server/net/NetworkPolicyManagerService;->setUidNetworkUncheckedLocked(IIZZ)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 3813
    .end local v0    # "oldEnable":Z
    :cond_3
    :try_start_3
    iget-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidWifiPolicy:Landroid/util/SparseBooleanArray;
...
.method updateRulesForDataUsageRestrictionsUL(IZ)V
    .locals 12
    .param p1, "uid"    # I
    .param p2, "uidDeleted"    # Z
