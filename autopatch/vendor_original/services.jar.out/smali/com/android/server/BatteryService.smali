...
.method private showConfirmDialog()V
    ...
    const-string/jumbo v2, "low charging warning dialog is Showing up"
    ...
    const-string/jumbo v2, "low charging warning has been confrimed,no need to show dialog"
    ...
    const-string/jumbo v2, "low charging warning,show confirm dialog"
...
.method private shutdownIfWeakChargerEmptySOCLocked()V
    ...
    const-string/jumbo v3, "silent_reboot shutdownIfWeakChargerEmptySOCLocked"
    ...
    const-string/jumbo v3, "shutdownIfWeakChargerEmptySOC"
...
.method private shutdownIfWeakChargerVoltageCheckLocked()V
    ...
    const-string/jumbo v8, "silent_reboot shutdownIfWeakChargerVoltageCheckLocked"
    ...
    const-string/jumbo v7, "shutdown_reason"

    const-string/jumbo v8, "shutdownIfWeakChargerVoltageCheck"
    ...
    const-string/jumbo v7, "android.intent.action.ACTION_REQUEST_SHUTDOWN"

    invoke-direct {v4, v7}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 461
    .local v4, "intent":Landroid/content/Intent;
    const-string/jumbo v7, "android.intent.extra.KEY_CONFIRM"
    ...
    const-string/jumbo v8, "Failure in reading battery voltage"
...
.method private startDelayToCheck()V
    ...
    const-string/jumbo v2, "now temperature is "
    ...
    const-string/jumbo v2, " ,start to delay 5 mins to check battery temperature again"
    ...
    const-string/jumbo v1, "has been check battery temperature or is showing warning, ignore this time"
...
.method public onStart()V
    ...
    const-string/jumbo v2, "BatteryService"
