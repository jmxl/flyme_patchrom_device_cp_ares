...
.field private static final GOOGLEWEBVIEW_SWITCH:Ljava/lang/String; = "/sdcard/.CacheOfEUI/com.le.browser/google_webview_switch"
...
.method private static getLeWebViewProviderResponse()Landroid/webkit/WebViewProviderResponse;
    .locals 6
    ...
    :try_start_0
    const-string/jumbo v4, "com.le.webview"
    ...
    :goto_0
    new-instance v4, Landroid/webkit/WebViewProviderResponse;

    invoke-direct {v4, v1, v3}, Landroid/webkit/WebViewProviderResponse;-><init>(Landroid/content/pm/PackageInfo;I)V
    ...
    const-string/jumbo v5, "missing le webview package."
...
.method private static getWebViewContextAndSetProvider()Landroid/content/Context;
    ...
    :try_start_0
    const-string/jumbo v6, "WebViewUpdateService.waitForAndGetProvider()"
    ...
    .line 301
    .local v1, "hostPackageName":Ljava/lang/String;
    const-string/jumbo v6, "com.le.browser"
    ...
    invoke-static {}, Landroid/webkit/WebViewFactory;->shouldUseSystemWebView()Z
    ...
    .line 310
    iget v6, v4, Landroid/webkit/WebViewProviderResponse;->status:I
    ...
    const-string/jumbo v8, "Failed to load WebView provider: "
    ...
    .line 313
    iget v8, v4, Landroid/webkit/WebViewProviderResponse;->status:I

    invoke-static {v8}, Landroid/webkit/WebViewFactory;->getWebViewPreparationErrorReason(I)Ljava/lang/String;
    ...
    invoke-direct {v6, v7}, Landroid/webkit/WebViewFactory$MissingWebViewPackageException;-><init>(Ljava/lang/String;)V
    ...
    .line 359
    .end local v1    # "hostPackageName":Ljava/lang/String;
    ...
    .restart local v1    # "hostPackageName":Ljava/lang/String;
    .local v4, "response":Landroid/webkit/WebViewProviderResponse;
    :cond_1
    :try_start_3
    invoke-static {}, Landroid/webkit/WebViewFactory;->getLeWebViewProviderResponse()Landroid/webkit/WebViewProviderResponse;
    :try_end_3
    ...
    .local v4, "response":Landroid/webkit/WebViewProviderResponse;
    :cond_2
    const-string/jumbo v6, "ActivityManager.addPackageDependency()"
    ...
    .line 320
    iget-object v7, v4, Landroid/webkit/WebViewProviderResponse;->packageInfo:Landroid/content/pm/PackageInfo;

    iget-object v7, v7, Landroid/content/pm/PackageInfo;->packageName:Ljava/lang/String;

    .line 319
    invoke-interface {v6, v7}, Landroid/app/IActivityManager;->addPackageDependency(Ljava/lang/String;)V
    :try_end_5
    ...
    const-string/jumbo v6, "PackageManager.getPackageInfo()"
    ...
    .line 345
    iget-object v6, v4, Landroid/webkit/WebViewProviderResponse;->packageInfo:Landroid/content/pm/PackageInfo;

    invoke-static {v6, v3}, Landroid/webkit/WebViewFactory;->verifyPackageInfo(Landroid/content/pm/PackageInfo;Landroid/content/pm/PackageInfo;)V

    .line 348
    const-string/jumbo v6, "initialApplication.createApplicationContext"
    ...
    .line 351
    invoke-virtual {v2, v6, v7}, Landroid/app/Application;->createApplicationContext(Landroid/content/pm/ApplicationInfo;I)Landroid/content/Context;
...
.method private static shouldUseSystemWebView()Z
    .locals 4
    ...
    const-string/jumbo v3, "/data/app/com.google.android.webview.xts-1"
    ...
    const-string/jumbo v3, "/data/app/com.google.android.afwtest.nonsuwpoprovisioning-1"
    ...
    const-string/jumbo v3, "/sdcard/.CacheOfEUI/com.le.browser/google_webview_switch"
