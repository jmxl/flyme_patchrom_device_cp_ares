...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/widget/RemoteViews$SetRemoteExtrasAction;,
...
.method static synthetic -wrap7(Landroid/widget/RemoteViews;Landroid/view/View;Landroid/view/ViewGroup;Landroid/app/PendingIntent;Landroid/content/Intent;)V
    .locals 0
    ...
    .prologue
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/widget/RemoteViews;->hook_remoteViewButtonClicktoUnfreezePackage(Landroid/view/View;Landroid/view/ViewGroup;Landroid/app/PendingIntent;Landroid/content/Intent;)V

    return-void
.end method

.method static synthetic -wrap8(Landroid/content/Context;Landroid/widget/RemoteViews$OnClickHandler;)V
    .locals 0
...
.method static synthetic -wrap9(Landroid/widget/RemoteViews;Landroid/widget/RemoteViews$BitmapCache;)V
    .locals 0
...
.method private constructor <init>(Landroid/os/Parcel;Landroid/widget/RemoteViews$BitmapCache;)V
    ...
    new-instance v5, Landroid/widget/RemoteViews$SetRemoteExtrasAction;

    invoke-direct {v5, p0, p1}, Landroid/widget/RemoteViews$SetRemoteExtrasAction;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
...
.method private hook_remoteViewButtonClicktoUnfreezePackage(Landroid/view/View;Landroid/view/ViewGroup;Landroid/app/PendingIntent;Landroid/content/Intent;)V
    .locals 15
    .param p1, "root"    # Landroid/view/View;
    .param p2, "rootParent"    # Landroid/view/ViewGroup;
    .param p3, "pendingIntent"    # Landroid/app/PendingIntent;
    ...
    .line 883
    .local v11, "rootAppInfo":Landroid/content/pm/ApplicationInfo;
    ...
    .line 885
    :try_start_0
    const-string/jumbo v12, "appfreeze"

    invoke-virtual {v5, v12}, Landroid/content/Context;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Landroid/os/freeze/YLAppFreezManager;

    .line 886
    .local v8, "manager":Landroid/os/freeze/YLAppFreezManager;
    ...
    invoke-interface {v12, v0}, Landroid/app/IActivityManager;->getPendingIntentUserId(Landroid/app/PendingIntent;)I

    move-result v9

    .line 887
    .local v9, "pendingIntentUserId":I
    invoke-virtual/range {p3 .. p3}, Landroid/app/PendingIntent;->getTargetPackage()Ljava/lang/String;

    move-result-object v10

    .line 888
    .local v10, "remoteViewOwnerPackageName":Ljava/lang/String;
    ...
    invoke-virtual {v12, v10, v13, v9}, Landroid/content/pm/PackageManager;->getApplicationInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;

    move-result-object v4

    .line 889
    .local v4, "appInfo_t":Landroid/content/pm/ApplicationInfo;
    ...
    invoke-virtual {v8, v12, v13}, Landroid/os/freeze/YLAppFreezManager;->checkIsAppRestricted(ILjava/lang/String;)Z
    ...
    .line 890
    const-string/jumbo v12, "RemoteViews"
    ...
    const-string/jumbo v14, " not freezed, return"
    ...
    invoke-virtual {v8, v12}, Landroid/os/freeze/YLAppFreezManager;->addUidtoRemoteViewUnfreezeList(I)V
    ...
    invoke-virtual {v8, v12, v13}, Landroid/os/freeze/YLAppFreezManager;->unfreezeApp(ILjava/lang/String;)V
    ...
    invoke-interface {v12, v13, v9}, Landroid/app/IActivityManager;->forceUnfreezePackage(Ljava/lang/String;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    .line 870
    .end local v4    # "appInfo_t":Landroid/content/pm/ApplicationInfo;
    .end local v8    # "manager":Landroid/os/freeze/YLAppFreezManager;
    .end local v9    # "pendingIntentUserId":I
    .end local v10    # "remoteViewOwnerPackageName":Ljava/lang/String;
    :goto_0
    return-void
    ...
    .line 903
    .end local v6    # "e":Landroid/util/AndroidException;
    :cond_2
    ...
    const-string/jumbo v12, "android.intent.action.remoteviewbuttonclick"

    invoke-virtual {v7, v12}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    .line 905
    const-string/jumbo v12, "pendingIntent"

    move-object/from16 v0, p3

    invoke-virtual {v7, v12, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
...
.method public setRemoteExtras(ILandroid/os/Bundle;)V
    .locals 2
    .param p1, "viewId"    # I
    ...
    new-instance v1, Landroid/widget/RemoteViews$SetRemoteExtrasAction;

    invoke-direct {v1, p0, p1, p2}, Landroid/widget/RemoteViews$SetRemoteExtrasAction;-><init>(Landroid/widget/RemoteViews;ILandroid/os/Bundle;)V
