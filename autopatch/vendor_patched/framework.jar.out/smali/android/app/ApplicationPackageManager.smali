...
.method private setResourceApplicationInfo(Landroid/content/res/Resources;Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-virtual {v0}, Landroid/app/ContextImpl;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->setContext(Landroid/content/Context;)V
...
.method public getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v8}, Landroid/app/ContextImpl;->getApplicationContext()Landroid/content/Context;

    move-result-object v8

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->setContext(Landroid/content/Context;)V

    const/4 v8, 0x0

    invoke-virtual {v7, p2, v8}, Landroid/content/res/Resources;->getDrawable(ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 1095
    const-string/jumbo v8, "com.icoolme.zmweather"
    ...
    .line 1096
    const-string/jumbo v8, "com.journeyui.calendar"
    ...
    .line 1097
    const-string/jumbo v8, "com.android.calendar"
    ...
    .line 1098
    const-string/jumbo v8, "com.yulong.android.calendar"
    ...
    .line 1099
    const-string/jumbo v8, "com.android.providers.calendar"
    ...
    .restart local v5    # "isDynamicIcon":Z
    ...
    const-string/jumbo v10, "Failure retrieving resources for "
    ...
    .line 1125
    iget-object v10, p3, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;
    ...
    const-string/jumbo v10, "Failure retrieving icon 0x"
...
.method public getResourcesForApplication(Landroid/content/pm/ApplicationInfo;)Landroid/content/res/Resources;
    ...
    .line 1327
    .local v9, "systemResources":Landroid/content/res/Resources;
    invoke-direct {p0, v9, p1}, Landroid/app/ApplicationPackageManager;->setResourceApplicationInfo(Landroid/content/res/Resources;Landroid/content/pm/ApplicationInfo;)V

    .line 1328
    return-object v9

    .line 1332
    .end local v9    # "systemResources":Landroid/content/res/Resources;
    :cond_0
    ...
    .line 1339
    .local v7, "r":Landroid/content/res/Resources;
    invoke-direct {p0, v7, p1}, Landroid/app/ApplicationPackageManager;->setResourceApplicationInfo(Landroid/content/res/Resources;Landroid/content/pm/ApplicationInfo;)V
...
.method public getUserBadgeForDensityNoBackground(Landroid/os/UserHandle;I)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    const v0, #android:drawable@ic_dual_app_no_bg#t
...
.method public loadUnbadgedItemIcon(Landroid/content/pm/PackageItemInfo;Landroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, v4}, Landroid/content/res/Resources;->setActivityInfo(Landroid/content/pm/ActivityInfo;)V
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0, v4, v5, p2}, Landroid/app/ApplicationPackageManager;->getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
...
.method public queryIntentActivitiesAsUser(Landroid/content/Intent;II)Ljava/util/List;
    ...
    invoke-virtual {p1, v10}, Landroid/content/Intent;->resolveTypeIfNeeded(Landroid/content/ContentResolver;)Ljava/lang/String;

    move-result-object v10

    .line 854
    invoke-interface {v9, p1, v10, p2, p3}, Landroid/content/pm/IPackageManager;->queryIntentActivities(Landroid/content/Intent;Ljava/lang/String;II)Landroid/content/pm/ParceledListSlice;

    move-result-object v5

    .line 857
    .local v5, "parceledList":Landroid/content/pm/ParceledListSlice;, "Landroid/content/pm/ParceledListSlice<Landroid/content/pm/ResolveInfo;>;"
    if-nez v5, :cond_0
    ...
    .line 864
    .local v6, "parceledListSize":I
    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    .line 865
    .local v3, "mPackagesSupportDualApp":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    const v10, #android:array@packages_support_dual_app#t
    ...
    .line 880
    .end local v1    # "i":I
    .end local v3    # "mPackagesSupportDualApp":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v4    # "packageNames":[Ljava/lang/String;
    .end local v6    # "parceledListSize":I
    ...
    .line 881
    .end local v5    # "parceledList":Landroid/content/pm/ParceledListSlice;, "Landroid/content/pm/ParceledListSlice<Landroid/content/pm/ResolveInfo;>;"
    :catch_0
    move-exception v0
