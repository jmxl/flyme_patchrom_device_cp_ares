...
.field private mFreezeLock:Ljava/lang/Object;
...
.field private final mUidFreezeState:Landroid/util/SparseIntArray;
...
.method protected constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;Landroid/net/metrics/IpConnectivityLog;)V
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->isInstrusmentTestSet:Z
    ...
    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mUidFreezeState:Landroid/util/SparseIntArray;
    ...
    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mFreezeLock:Ljava/lang/Object;
...
.method private callCallbackForRequest(Lcom/android/server/ConnectivityService$NetworkRequestInfo;Lcom/android/server/connectivity/NetworkAgentInfo;II)V
    ...
    .line 4778
    :cond_0
    iget-object v4, p0, Lcom/android/server/ConnectivityService;->mFreezeLock:Ljava/lang/Object;

    monitor-enter v4

    .line 4779
    :try_start_0
    iget-object v3, p0, Lcom/android/server/ConnectivityService;->mUidFreezeState:Landroid/util/SparseIntArray;
...
.method public isInstrusmentTestSet()Z
    .locals 1

    .prologue
    .line 5623
    iget-boolean v0, p0, Lcom/android/server/ConnectivityService;->isInstrusmentTestSet:Z
...
.method public requestNetwork(Landroid/net/NetworkCapabilities;Landroid/os/Messenger;ILandroid/os/IBinder;I)Landroid/net/NetworkRequest;
    ...
    .line 4148
    sget-object v11, Landroid/net/NetworkRequest$Type;->TRACK_DEFAULT:Landroid/net/NetworkRequest$Type;

    .line 4153
    .local v11, "type":Landroid/net/NetworkRequest$Type;
    :goto_0
    sget-object v13, Landroid/net/NetworkRequest$Type;->TRACK_DEFAULT:Landroid/net/NetworkRequest$Type;
    ...
    iget-object v13, v13, Landroid/net/NetworkRequest;->networkCapabilities:Landroid/net/NetworkCapabilities;
    ...
    invoke-virtual {v4, v13, v12, v8}, Landroid/app/AppOpsManager;->noteOpNoThrow(IILjava/lang/String;)I
    ...
    .end local v11    # "type":Landroid/net/NetworkRequest$Type;
    .end local v12    # "uid":I
    :cond_1
    sget-object v11, Landroid/net/NetworkRequest$Type;->REQUEST:Landroid/net/NetworkRequest$Type;

    .restart local v11    # "type":Landroid/net/NetworkRequest$Type;
    goto :goto_0
    ...
    invoke-direct {v5, v0}, Landroid/net/NetworkCapabilities;-><init>(Landroid/net/NetworkCapabilities;)V

    .line 4158
    .end local p1    # "networkCapabilities":Landroid/net/NetworkCapabilities;
    .local v5, "networkCapabilities":Landroid/net/NetworkCapabilities;
    move-object/from16 v0, p0

    invoke-direct {v0, v5}, Lcom/android/server/ConnectivityService;->enforceNetworkRequestPermissions(Landroid/net/NetworkCapabilities;)V

    .line 4162
    move-object/from16 v0, p0

    invoke-direct {v0, v5}, Lcom/android/server/ConnectivityService;->enforceMeteredApnPolicy(Landroid/net/NetworkCapabilities;)V

    move-object/from16 p1, v5

    .end local v5    # "networkCapabilities":Landroid/net/NetworkCapabilities;
    .restart local p1    # "networkCapabilities":Landroid/net/NetworkCapabilities;
    goto :goto_1
    ...
    const-string/jumbo v14, "Bad timeout specified"
    ...
    const-string/jumbo v14, "Invalid network specifier - must not be \'*\'"
    ...
    .line 4196
    :cond_6
    new-instance v6, Landroid/net/NetworkRequest;
    ...
    invoke-direct {v6, v0, v1, v13, v11}, Landroid/net/NetworkRequest;-><init>(Landroid/net/NetworkCapabilities;IILandroid/net/NetworkRequest$Type;)V

    .line 4198
    .local v6, "networkRequest":Landroid/net/NetworkRequest;
    new-instance v7, Lcom/android/server/ConnectivityService$NetworkRequestInfo;
    ...
    invoke-direct {v7, v0, v1, v6, v2}, Lcom/android/server/ConnectivityService$NetworkRequestInfo;-><init>(Lcom/android/server/ConnectivityService;Landroid/os/Messenger;Landroid/net/NetworkRequest;Landroid/os/IBinder;)V
    ...
    const-string/jumbo v14, "requestNetwork for "
    ...
    iget-object v14, v0, Lcom/android/server/ConnectivityService;->mHandler:Lcom/android/server/ConnectivityService$InternalHandler;

    const/16 v15, 0x13

    invoke-virtual {v14, v15, v7}, Lcom/android/server/ConnectivityService$InternalHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v14

    invoke-virtual {v13, v14}, Lcom/android/server/ConnectivityService$InternalHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    invoke-virtual {v13, v14, v0, v1}, Lcom/android/server/ConnectivityService$InternalHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method public setInstrusmentTest(Z)V
    ...
    invoke-interface {v1, p1}, Landroid/os/INetworkManagementService;->setInstrusmentTest(Z)V

    .line 5630
    iput-boolean p1, p0, Lcom/android/server/ConnectivityService;->isInstrusmentTestSet:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "Error setInstrusmentTest"
...
.method public setUidFreezeStatus(IZ)V
    .locals 4
    .param p1, "uid"    # I
    .param p2, "frozen"    # Z
    ...
    .line 5641
    .local v0, "caliingUid":I
    const/16 v1, 0x3e8

    if-ne v0, v1, :cond_0

    .line 5642
    iget-object v2, p0, Lcom/android/server/ConnectivityService;->mFreezeLock:Ljava/lang/Object;
...
.method public startTethering(ILandroid/os/ResultReceiver;Z)V
    ...
    const-string/jumbo v2, "startTethering: "
...
.method public stopTethering(I)V
    ...
    const-string/jumbo v2, "stopTethering: "
